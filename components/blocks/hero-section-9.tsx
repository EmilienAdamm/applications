...
export const HeroSection = ({ hideNav = false }: HeroSectionProps) => {
                ...
                <section className="overflow-hidden bg-white dark:bg-transparent">
                    <div className="relative mx-auto max-w-5xl px-6 py-28 lg:py-24">
                        <div className="relative z-10 mx-auto max-w-2xl text-center">
                            <h1 className="text-balance text-4xl font-semibold md:text-5xl lg:text-6xl">Take control of your job applications.</h1>
                            <p className="mx-auto my-8 max-w-2xl text-xl">Log every application, track statuses, and spot trends with one fast workspace built for serious job hunting.</p>
                            ...
                            <div className="[transform:rotateX(20deg);]">
                                <div className="lg:h-[44rem] relative skew-x-[.36rad]">
                                    <Image
                                        ...
                                        src="/landing-analysis-preview.png"
